...
$query = "DELETE FROM notas_externas WHERE id = '$id'";
...
if(mysqli_query($_SG['link'], $query)){
    ...
    mysqli_query($_SG['link'], "INSERT INTO log_sistema_alunos (id_usuario, id_usuario_afetado, acao, date_time) VALUES ('$id_usuario_afetado','$id_usuario', 'excluir-notas-externas', '$time')");
